...
export default function RecipePage() {
    ...
    useEffect( ()=> {
        axios
            .get("https://api.spoonacular.com/recipes/10123/information?apiKey=" + apiKey)
            // .then(response => {
    ...
    <div className="recipe-page-container">    
        <div className="recipe-page-container-grid w-5/6 grid gap-0 grid-cols-2 ml-16">
            ...
            <div className="buttonsContainer ml-20 justify-self-center">
                <button type="button" onClick={addHandler} class="AddReviewButton text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                    Add Review</button>

                <button type="button" class="AddTrackerButton text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
            ...
            {/*Ingredients Portion */}
            <div>
                <h2 class="text-center text-3xl mb-2 mt-20"
