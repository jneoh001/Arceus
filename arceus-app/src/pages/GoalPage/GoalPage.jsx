    ...
    <div className="h-screen overflow-hidden">
      ...
      <div className="flex h-screen">
        ...
        <div className="flex flex-col items-center w-full">
          <h1 className="font-bold text-4xl border-b-2 border-black w-full text-center pt-4 pb-2 mb-4">
            ❤️ Favourites ❤️
          </h1>
          <div className="flex flex-col gap-10 whitespace-nowrap overflow-auto h-5/6">
